    ...
    <section className="py-16 bg-background">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-primary p-6 rounded-lg mb-2">
          ...
          >
            <h3 className="text-background text-xl">Phase 1: Planning & Setup</h3>
        ...
        <div className="bg-primary p-6 rounded-lg mb-2">
          ...
          >
            <h3 className="text-background text-xl">Phase 2: Core UI/UX Development</h3>
            <span className="text-background">
        ...
        <div className="bg-primary p-6 rounded-lg mb-2">
          ...
          >
            <h3 className="text-background text-xl">Phase 3: Blockchain Integration</h3>
            <span className="text-background">
        ...
        <div className="bg-primary p-6 rounded-lg mb-2">
          ...
          >
            <h3 className="text-background text-xl">Phase 4: Backend & Game Integration</h3>
            <span className="text-background">
        ...
        <div className="bg-primary p-6 rounded-lg mb-2">
          ...
          >
            <h3 className="text-background text-xl">Phase 5: Advanced Features</h3>
            <span className="text-background">
        ...
        <div className="bg-primary p-6 rounded-lg mb-2">
          ...
          >
            <h3 className="text-background text-xl">Phase 6: Testing & QA</h3>
            <span className="text-background">
        ...
        <div className="bg-primary p-6 rounded-lg mb-2">
          ...
          >
            <h3 className="text-background text-xl">Phase 7: Deployment & Marketing</h3>
            <span className="text-background">
        ...
        <div className="bg-primary p-6 rounded-lg mb-2">
          ...
          >
            <h3 className="text-background text-xl">Phase 8: Post-Launch Iterations</h3>
            <span className="text-background">
